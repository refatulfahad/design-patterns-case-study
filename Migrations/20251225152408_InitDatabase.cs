...
namespace design_pattern_case_1.Migrations
{
    ...
    public partial class InitDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PostVoteId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PostId = table.Column<int>(type: "int", nullable: false),
                    VotedByUserId = table.Column<int>(type: "int", nullable: false),
                    IsAdmin = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostVotes_Users_VotedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostVotes_PostId_VotedByUserId",
                table: "PostVotes",
                columns: new[] { "PostId", "VotedByUserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PostVotes_VotedByUserId",
                table: "PostVotes",
